...
export default function ArtisanDashboard() {
  ...
  const artisanProducts = products.filter(p => p.artisan_id === 1);
    ...
    <div className="min-h-screen bg-harar-cream">
      ...
      <div className="fixed left-0 top-0 h-full w-64 bg-white shadow-lg z-50">
        <div className="p-6">
          ...
          <p className="text-sm text-harar-brown/60">Fatima Ahmed</p>
        </div>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <MetricCard
                  ...
                  value={artisanOrders.length}
                  icon={ShoppingCart}
                  trend={12.3}
                />
                <MetricCard
                  title="Active Products"
                  value={artisanProducts.filter(p => p.isActive).length}
                  icon={Package}
                  trend={5.2}
                />
                <MetricCard
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="card">
                  ...
                  <CategoryPieChart data={mockChartData.categoryDistribution} />
                </div>
                <div className="card">
                  <h3 className="text-xl font-semibold text-harar-brown mb-4">Monthly Sales</h3>
                  <SalesBarChart data={mockChartData.monthlySales} />
                </div>
              </div>
            </motion.div>
          )}
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-6">
                <div className="card">
                  ...
                  <RevenueLineChart data={mockChartData.monthlySales} />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="card">
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <div className="card max-w-2xl">
                <form className="space-y-6" onSubmit={(e) => {
                  ...
                  fetch('http://localhost/api/controllers/auctions.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
                      action: 'request',
                      product_id: formData.get('product_id'),
                      product_name: artisanProducts.find(p => p.id == formData.get('product_id'))?.name,
                      product_image: artisanProducts.find(p => p.id == formData.get('product_id'))?.images[0],
                      artisan_id: 1,
                      artisan_name: 'Fatima Ahmed',
                    ...
                    if(data.success) {
                      alert('Auction request submitted! Waiting for admin approval.');
