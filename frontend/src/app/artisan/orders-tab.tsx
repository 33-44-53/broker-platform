          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-harar-sand">
                ...
                <th className="text-left py-4 px-4 text-harar-brown font-semibold">Buyer</th>
              ...
              {orders.map((order) => (
                <tr key={order.id} className="border-b border-harar-sand/50 hover:bg-harar-sand/20">
                  ...
                  <td className="py-4 px-4">
                    <div>
                      <p className="font-medium text-harar-brown">{order.buyerName}</p>
                      <p className="text-sm text-harar-brown/60">{order.buyerEmail}</p>
                    </div>
                  </td>
                  ...
                  <td className="py-4 px-4">
                    <button
                      onClick={() => alert(`Buyer: ${order.buyerName}\nEmail: ${order.buyerEmail}\nPhone: ${order.buyerPhone}\nAddress: ${order.deliveryAddress}`)}
                      className="px-3 py-1 text-xs font-semibold bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition"
                    >
                      View Details
                    </button>
                  </td>
